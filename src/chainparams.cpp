...
{
    const char* pszTimestamp = "The Times 02/Feb/2018 Chancellor on brink of second bailout for banks";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517549962, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("000000006b03409c65456e7e8d761f1d0583419b0ce082460bea99a7c805b160"));
        assert(genesis.hashMerkleRoot == uint256S("e796b650bd9ab65feba55091ae08d4332b08a759e96b68d9f91a75612464cb46"));
...
//        vSeeds.push_back(CDNSSeedData("bitcoin.jonasschnelli.ch", "seed.bitcoin.jonasschnelli.ch", true)); // Jonas Schnelli, only supports x1, x5, x9, and xd
        ...
        checkpointData = (CCheckpointData) {
			...
			( 0, uint256("0x001")),
			1517476070, // * UNIX timestamp of last checkpoint block
